...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://cheptoosherile:fidelOmondi@cluster0.r40itkm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', mongoParams)
  .then(() => {
    app.listen(PORT, () => {
